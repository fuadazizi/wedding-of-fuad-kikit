const config = {
  data: {
    ...
    groomName: "Fuad",
    groomFullName: "Nur Fuad Azizi S.Kom.",
    groomIg: "n.fuadazizi",
    groomText: "Putra pertama dari",
    brideName: "Kikit",
    brideFullName: "Kikit Elisa Yuniarti S.Pd.Gr.",
    ...
    maps_notes:
      "Bagi yang membawa mobil dapat parkir di Rancamanyar Regency 3. Terima kasih.",
    ...
    audio: {
      ...
      title: "Bermuara - Rizky Febian ft. Mahalini", // or Nature Sound
