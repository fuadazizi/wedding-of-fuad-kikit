...
function generateInvitationLink(
  uid,
  guestName,
  baseUrl = "https://fuad-with-kikit.my.id",
) {
...
// ===== CONFIGURATION =====
const INVITATION_UID = "fuad-kikit"; // Change this to your invitation UID
const BASE_URL = "https://fuad-with-kikit.my.id"; // Change this to your production URL
